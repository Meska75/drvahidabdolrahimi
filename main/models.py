...
class DoctorClinic(models.Model):
    ...
    phone_1 = models.CharField(max_length=30, blank=True, verbose_name='تلفن اول (فارسی)')
    phone_2 = models.CharField(max_length=30, blank=True, verbose_name='تلفن دوم (فارسی)')
    ...
    phone_1_ar = models.CharField(max_length=30, blank=True, verbose_name='هاتف ۱ (عربي)')
    phone_2_ar = models.CharField(max_length=30, blank=True, verbose_name='هاتف ۲ (عربي)')
