...
class DoctorClinic(models.Model):
    ...
    # دو شماره × سه زبان — مثل آدرس و ساعت کاری
    phone_1_fa = models.CharField(max_length=30, blank=True, verbose_name='تلفن اول فارسی')
    phone_1_en = models.CharField(max_length=30, blank=True, verbose_name='Phone 1 English')
    phone_1_ar = models.CharField(max_length=30, blank=True, verbose_name='هاتف ١ عربي')
    phone_2_fa = models.CharField(max_length=30, blank=True, verbose_name='تلفن دوم فارسی')
    phone_2_en = models.CharField(max_length=30, blank=True, verbose_name='Phone 2 English')
    phone_2_ar = models.CharField(max_length=30, blank=True, verbose_name='هاتف ٢ عربي')
