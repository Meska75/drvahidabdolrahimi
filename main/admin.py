...
class DoctorClinicAdmin(admin.ModelAdmin):
    list_display = ('name_fa', 'city_fa', 'phone_1_fa', 'phone_1_en', 'is_active', 'sort_order')
    list_editable = ('is_active', 'sort_order')
    search_fields = (
        'name_fa',
        'phone_1_fa', 'phone_2_fa',
        'phone_1_en', 'phone_2_en',
        'phone_1_ar', 'phone_2_ar',
    )
    fieldsets = (
        ...
        ('تلفن‌ها', {
            'description': (
                'مثل آدرس: برای هر زبان جداگانه پر کنید. '
                'فارسی ← ارقام فارسی (۰۲۱-…) | '
                'English ← ارقام لاتین (021-…) | '
                'العربية ← حسب النسخة العربية. '
                'هر زبان فقط شماره همان زبان را در سایت نشان می‌دهد.'
            ),
            'fields': (
                'phone_1_fa', 'phone_1_en', 'phone_1_ar',
                'phone_2_fa', 'phone_2_en', 'phone_2_ar',
            ),
        }),
        ('آدرس', {
